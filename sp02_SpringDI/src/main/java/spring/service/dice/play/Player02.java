 ...
 *	ㅇ Player01에서는 DiceA 을 직접 가지고 있는 관계였다면(Tight한 Coupling)
 *  ㅇ DiceB, DiceC를 추가할 때마다 Player01에서 수정되어져야 하는 코드가 기하급수적으로 늘어남으로써 재사용성에 치명적인 결과를 야기한다.
...
public class Player02 {
	...
	///Field
	private Dice dice; // interface를 hasing
