...
public class DiceTestAppUseSpring {
	public static void main(String[] args) {
		...
		Player02 player02 = (Player02)factory.getBean("player02"); // 생성자 주입
		player02.playDice(3);
		System.out.println("======================");
		System.out.println("선택된 주사위 수의 통합은 :"+ player02.getTotalValue());
		System.out.println("=============\n\n");
		
		Player02 player03 = (Player02)factory.getBean("player03"); // setter주입 .. C
		player03.playDice(3);
		System.out.println("======================");
		System.out.println("선택된 주사위 수의 통합은 :"+ player03.getTotalValue());
		System.out.println("=============\n\n");
		
		Player02 player04 = (Player02)factory.getBean("player04"); // setter주입.. A
		player04.playDice(3);
		System.out.println("======================");
